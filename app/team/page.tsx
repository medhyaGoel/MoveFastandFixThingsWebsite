...
export default function Team() {
  return (
    <div className="min-h-screen bg-[#0a0a0a] text-white">
      <section className="h-screen pt-16 pb-0 px-2 md:px-4 lg:px-6">
        <div className="mx-auto max-w-[1700px]">
          ...
          <div className="mt-8 md:mt-0 grid grid-cols-1 md:grid-cols-12 gap-5 md:gap-5 items-stretch">
            ...
            >
              ...
              <p className="mb-8 text-white/80 text-lg leading-relaxed font-light text-balance">
                <span className="font-medium">&gt;&gt;&gt;Medhya Goel</span> studies computer science and government at Stanford University, with a focus on national security policy. She has engineered systems serving millions of users at Meta & Stripe, secured open-source software & contributed to an Executive Order on cybersecurity at the Cybersecurity & Infrastructure Security Agency, and automated criminal records expungement at Rasa Legal. She has worked on projects involving cybersecurity, election integrity, and public interest technology.
              </p>
            </motion.div>
